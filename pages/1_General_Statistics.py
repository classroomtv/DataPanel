...
import gettext
from utils.auxiliar_functions import to_excel, plotly_fig2array, get_year_range, hide_page, nav_page, load_database, plot_users, plot_top_institutions
...
df_collaborators_selection = df_users_selection[df_users_selection["is_admin"]!=1]
df_admins_selection = df_users_selection[df_users_selection["is_admin"]==1]

df_logs_by_date_selection = logs_by_date_df[logs_by_date_df["institution_id"].isin(df_institutions_selection["id"])]
df_logs_collaborators_selection = df_logs_by_date_selection[df_logs_by_date_selection["is_admin"]!=1]
df_logs_admins_selection = df_logs_by_date_selection[df_logs_by_date_selection["is_admin"]==1]
...
#All the created figs
fig_users_by_institution = plot_top_institutions(df_institutions_selection, selected_col=("total_users"), title=_("Users by institution"), x_label=_("Year"), y_label=_("Users"))
fig_collaborators_by_institution = plot_top_institutions(df_institutions_selection, selected_col="collaborator_users", title=_("Collaborators users by institution"), x_label=_("Year"), y_label=_("Users"))
fig_admin_by_institution = plot_top_institutions(df_institutions_selection, selected_col="admin_users", title=_("Admin users by institution"), x_label=_("Year"), y_label=_("Users"))

fig_users_by_year = plot_users(df_users_selection, title=_("Users created by year"), x_label=_("Year"), y_label=_("Users"))
fig_users_logs_by_year = plot_users(df_logs_by_date_selection,title=_("Logged users by year"), x_label=_("Year"), y_label=_("Users"))

fig_collaborators_by_year = plot_users(df_collaborators_selection, title=_("Collaborators users created by year"), x_label=_("Year"), y_label=_("Users"))
fig_collaborators_logs_by_year = plot_users(df_logs_collaborators_selection,title=_("Collaborators users logged by year"), x_label=_("Year"), y_label=_("Users"))

fig_admin_by_year = plot_users(df_admins_selection, title=_("Admin users created by year"), x_label=_("Year"), y_label=_("Users"))
fig_admin_logs_by_year = plot_users(df_logs_admins_selection, title=_("Admins users logged by year"), x_label=_("Year"), y_label=_("Users"))

fig_created_courses_by_institution = plot_top_institutions(df_course_selection, selected_col="id", title=_("Created courses by Institution"), x_label=_("Courses created"), y_label=_("Institution")) 
fig_courses_view_by_institution = plot_top_institutions(df_course_selection, selected_col="view_count", title=_("Courses views count by Institution"), x_label=_("Views"), y_label=_("Institution")) 
...
with st.expander("**{}**".format(_("Metrics")), expanded=True):
    ...
    with tab1:
        ...
        left_column.plotly_chart(fig_users_by_year, use_container_width=True)#   fig_users_by_year, use_container_width=True)
        right_column.plotly_chart(fig_users_logs_by_year, use_container_width=True)
        
    with tab2:
        st.header(_("Collaborators"))
        st.header(_("Created collaborators by date"))
        left_column, right_column = st.columns(2)
        left_column.plotly_chart(fig_collaborators_by_institution, use_container_width=True)
        left_column.plotly_chart(fig_collaborators_by_year, use_container_width=True)
        right_column.plotly_chart(fig_collaborators_logs_by_year, use_container_width=True)

    with tab3:
        st.header(_("Admins"))
        st.header(_("Created admin users by date"))
        left_column, right_column = st.columns(2)
        left_column.plotly_chart(fig_admin_by_institution, use_container_width=True)
        left_column.plotly_chart(fig_admin_by_year, use_container_width=True)
        right_column.plotly_chart(fig_admin_logs_by_year, use_container_width=True)
...
plot2 = plotly_fig2array(fig_users_logs_by_year)
plot3 = plotly_fig2array(fig_collaborators_by_institution)
