SELECT courses.id, title, name, institution_id, FROM_UNIXTIME(create_time,  '%Y-%m-%d') as create_time, view_count, author_id, user_finished_courses,  signed_users,  user_failed_courses
