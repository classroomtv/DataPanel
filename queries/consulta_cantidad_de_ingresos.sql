SELECT 
		ci.id,
		ci.`name` as Cliente,      
		(SELECT count(*) FROM ctv_user_belongs_institution ubia WHERE ubia.institution_id = ci.id ) as 'Usuarios totales',
		(SELECT count(*) FROM ctv_user_belongs_institution ubib WHERE ubib.institution_id = ci.id and ubib.active = 1 ) as 'Usuarios activos',
         (SELECT count(*) FROM ctv_user_belongs_institution ubic WHERE ubic.institution_id = ci.id and ubic.create_time >= 1514775599  and ubic.create_time < 1546311599  ) as 'Usuarios cargados 2018',
     
              (SELECT count(*) FROM ctv_user_belongs_institution ubic WHERE ubic.institution_id = ci.id and ubic.create_time >= 1546311599  and ubic.create_time < 1577847599  ) as 'Usuarios cargados 2019',
         (SELECT count(*) FROM ctv_user_belongs_institution ubic WHERE ubic.institution_id = ci.id and ubic.create_time >= 1577847599  and ubic.create_time < 1609469999  ) as 'Usuarios cargados 2020',
		
        (SELECT count(*) FROM ctv_user_belongs_institution ubic WHERE ubic.institution_id = ci.id and ubic.create_time >= 1609469999  and ubic.create_time < 1641006000  ) as 'Usuarios cargados 2021',
		(SELECT count(*) FROM ctv_user_belongs_institution ubic WHERE ubic.institution_id = ci.id and ubic.create_time >= 1641006000  ) as 'Usuarios cargados 2022',
        (
